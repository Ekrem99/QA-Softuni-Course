...
describe('rgbToHexColor', () => {
    it('should return undefined if red value is invalid', () => {
        //Arrange
        //Act
        const nonNumericRedValueResult = 
        rgbToHexColor('123', 0, 0)
        const negativeRedValueResult =
        rgbToHexColor(-123, 0, 0)
        const tooBigRedValue =
        rgbToHexColor(999, 0, 0)
        //Assert
    ...
    it('should return undefined if green value is invalid', () => {
        //Arrange
        //Act
        const nonNumericGreenValueResult = 
        rgbToHexColor(0, '123', 0)
        const negativeGreenValueResult =
        rgbToHexColor(0, -123, 0)
        const tooBigGreenValue =
        rgbToHexColor(0, 999, 0)
        //Assert
    ...
    it('should return undefined if blue value is invalid', () => {
        //Arrange
        //Act
        const nonNumericBlueValueResult = 
        rgbToHexColor(0, 0, '123')
        const negativeBlueValueResult =
        rgbToHexColor(0, 0, -123)
        const tooBigBlueValue =
        rgbToHexColor(0, 0, 999)
        //Assert
